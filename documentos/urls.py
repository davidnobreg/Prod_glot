...
urlpatterns = [
    ...
    path('modelos/<uuid:modelo_uuid>/', modelo_editor, name='modelo-editor'),
    path('modelos/<uuid:modelo_uuid>/salvar/', modelo_salvar, name='modelo-salvar'),
    path('modelos/salvar/', modelo_salvar, name='modelo-salvar-novo'),
    path('modelos/<uuid:modelo_uuid>/preview/', modelo_preview, name='modelo-preview'),
    path('modelos/<uuid:modelo_uuid>/historico/', modelo_historico, name='modelo-historico'),
    path('modelos/<uuid:modelo_uuid>/duplicar/', modelo_duplicar, name='modelo-duplicar'),
    path('modelos/<uuid:modelo_uuid>/toggle-ativo/', modelo_toggle_ativo, name='modelo-toggle-ativo'),
    ...
    path('doc/<uuid:documento_uuid>/', documento_detalhe, name='documento-detalhe'),
    path('doc/<uuid:documento_uuid>/preview/', documento_preview, name='documento-preview'),
    path('doc/<uuid:documento_uuid>/finalizar/', documento_finalizar, name='documento-finalizar'),
    path('doc/<uuid:documento_uuid>/status/', documento_status, name='documento-status'),
    path('doc/<uuid:documento_uuid>/cancelar/', documento_cancelar, name='documento-cancelar'),
]
