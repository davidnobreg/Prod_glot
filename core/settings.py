...
# Defaults de roteamento (alinha com celery.py)
CELERY_TASK_DEFAULT_EXCHANGE = "app_empreendimentos"
CELERY_TASK_DEFAULT_EXCHANGE_TYPE = "direct"
CELERY_TASK_DEFAULT_ROUTING_KEY = "empreendimentos"
...
JAZZMIN_SETTINGS = {
    ...
    # Copyright on the footer
    "copyright": "© 2025 David Nóbrega. Todos os direitos reservados.",
